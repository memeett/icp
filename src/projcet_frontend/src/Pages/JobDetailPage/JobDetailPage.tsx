...
export default function JobDetailPage() {
    ...
    const handleStartJob = () => {
        // Calculate the required amount (replace with your logic)
         // Example amount
         if(jobDetails){
                    ...
                    <div className="bg-white/90 backdrop-blur-md rounded-2xl shadow-2xl p-8 h-fit sticky top-6">
                        {isOwner ? (
                            ...
                            <div className="space-y-6">
                                ...
                                {/* Apply Button */}
                                <motion.button
                                    className={`w-full py-4 rounded-xl text-white font-semibold text-lg transition-all duration-300 ${applied ||
                                        !termsAccepted ||
