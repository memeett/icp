...
export default function ProfilePage() {
  ...
  useEffect(() => {
    if (current_user) {
      ...
      //   console.log(new Uint8Array(Object.values()));
      user.profilePicture = new Blob([user.profilePicture]);
      //   console.log("makkau" + user.profilePicture);
      setUser(user);
            ...
            {activeSection === "biodata" ? (
              user ? (
                <>
                  ...
                  <div
                    className={`relative bg-white shadow rounded-xl p-8 flex flex-col md:flex-row items-center md:items-start gap-6 border ${
                      isEditing
                      ...
                      <div className="grid gap-4">
                        <div>
                          ...
                          <input
                            ...
                            className={`w-full text-base font-medium text-gray-900 border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 ${
                              isEditing
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            className={`w-full text-gray-700 text-sm border rounded-lg px-4 py-2 resize-none focus:outline-none focus:ring-2 ${
                              isEditing
                                ? "border-blue-400 focus:ring-blue-400"
                                : "border-gray-300 bg-gray-100"
                            }`}
                  ...
                  <div className="flex justify-between bg-white shadow rounded-lg mt-3 p-6 border border-gray-200">
                    ...
                    <div
                      className={`w-12 h-6 flex items-center bg-gray-300 rounded-full p-1 cursor-pointer transition ${
                        faceRecognitionOn ? "bg-green-600" : "bg-gray-300"
                      }`}
                      onClick={handleToggle}
                    >
                      <div
                        className={`w-5 h-5 bg-white rounded-full shadow-md transform transition ${
                          faceRecognitionOn ? "translate-x-6" : "translate-x-0"
                        }`}
                      ></div>
                    </div>
                  </div>
