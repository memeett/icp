              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center mb-6">
                  <p className="text-gray-600">
                    You have {transactionsData.length} job
                    {transactionsData.length !== 1 ? "s" : ""} in your history
                  </p>
                ...
                {transactionsData.map((data) => (
                  <ClientHistoryCard
                    key={`${data.transaction.client}-${data.transaction.jobId}`}
                    data={data}
                  />
                ))}
              </div>
    ...
    if (job && job.jobStatus) {
      ...
      if (status === "completed" || status === "success") {
        return {
          ...
          icon: (
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h6 w-6 text-green-500"
              viewBox="0 0 20 20"
              fill="currentColor"
            >
              <path
      ...
      if (status === "In Progress" || status === "Ongoing") {
        return {
          ...
          icon: (
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h6 w-6 text-blue-500"
              viewBox="0 0 20 20"
              fill="currentColor"
            >
              <path
      ...
      return {
        ...
        icon: (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h6 w-6 text-purple-500"
            viewBox="0 0 20 20"
            fill="currentColor"
          >
            <path
      ...
      <div className="flex items-start">
        ...
        <div className="flex-1">
          <div className="flex justify-between items-start w-full">
            ...
            <span
              className={`px-3 py-1 rounded-full text-xs font-medium bg-${statusDetails.color}-100 text-${statusDetails.color}-800`}
            >
          ...
          <div className="mt-4 text-sm text-gray-600 border-t border-gray-100 pt-4">
            <p className="mb-2 flex">
              ...
              <span className="flex-1">
                {clientUser?.username || "Unknown Client"}
              </span>
            </p>
            <p className="mb-2 flex">
