                ...
                >
                    <div className="p-6">
                        ...
                        <div className="py-2">
                            {activeTab === "active" ? (
                                <div>
                                    <p className="mb-4 text-gray-600">Currently active projects you're working on.</p>
                                    {/* {renderJobList(activeJobs)} */}
                                </div>
                            ) : (
                                <div>
                                    <p className="mb-4 text-gray-600">Your completed job history.</p>
                                    {/* {renderJobList(historyJobs)} */}
                                </div>
                            )}
                        </div>
                    </div>
