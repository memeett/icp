                ...
                >
                    <div className="relative overflow-hidden h-32 bg-gradient-to-r from-blue-400 via-purple-500 to-pink-400">
                        ...
                        <div className="relative p-6 flex items-end h-full">
                            <h1 className="text-3xl font-bold text-white drop-shadow-md">Your Transactions</h1>
                        </div>
                    </div>
                        ...
                        {loading ? (
                            ...
                            <div className="space-y-4">
                                <div className="flex justify-between items-center mb-6">
                                    <p className="text-gray-600">You have {transactions.length} transaction{transactions.length !== 1 ? 's' : ''}</p>
                            ...
                            <div className="text-center py-12">
                                ...
                                <p className="text-gray-500">Your payment history will appear here once you have transactions.</p>
                                <button
                                    onClick={() => fetchTransactions()}
        ...
        <div className="bg-white rounded-lg shadow p-6 border border-purple-50 hover:border-purple-200 transition-all">
            <div className="flex justify-between items-start">
                <div className="flex items-center">
                    <div className={`p-3 rounded-full ${isIncoming ? "bg-green-100" : "bg-red-100"} mr-4`}>
                        <svg className={`h-6 w-6 ${isIncoming ? "text-green-600" : "text-red-600"}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            {isIncoming ? (
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500">{formatDate(transaction.transactionAt)}</p>
                    </div>
                </div>
