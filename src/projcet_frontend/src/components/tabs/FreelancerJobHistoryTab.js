...
export default function FreelancerJobHistoryTab() {
    ...
    return (_jsx("div", { children: historyJob.length === 0 ? (_jsxs("div", { className: "text-center py-16 px-4", children: [_jsx("div", { className: "p-4 bg-gradient-to-r from-blue-50 via-purple-50 to-pink-50 rounded-full inline-block mb-4", children: _jsx("svg", { className: "h-16 w-16 text-purple-400", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", d: "M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4" }) }) }), _jsx("h3", { className: "text-lg font-medium text-gray-600 mb-2", children: "No History Jobs" }), _jsx("p", { className: "text-gray-500", children: "You don't have any history jobs at the moment." }), _jsx("button", { onClick: () => fetchData(), className: "mt-6 px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 shadow-sm hover:shadow focus:outline-none focus:ring-2 focus:ring-purple-300 transition-all duration-300", children: "Refresh" })] })) : (_jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: historyJob.map((job, index) => (_jsx(FreelancerJobHistoryCard, { jobId: job.jobId, isLoading: () => setLoading(false) }, job.jobId + index))) })) }));
}
