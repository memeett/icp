...
;
export const getFreelancerForRating = async (job_id) => {
    ...
    try {
        ...
        const result = await rating.getRatingByJobId(job_id, userId, process.env.CANISTER_ID_USER, // Ensure this environment variable is set
...
export const ratingUser = async (rating_id, ratingValue) => {
    try {
...
export const getRatingByUserIdJobId = async (jobId, userId) => {
    const agent = await agentService.getAgent();
